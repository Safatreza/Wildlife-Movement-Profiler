# Behavior classification for wildlife telemetry data
import pandas as pd
import numpy as np
...
class RuleBasedClassifier:
    """Classifies behavior using simple rule-based logic on telemetry features."""
    def __init__(self):
        pass
...
class MLBehaviorClassifier:
    """Classifies behavior using a machine learning model (Random Forest)."""
    ...
    def predict(self, df: pd.DataFrame) -> pd.Series:
        """Predict behavior using the trained ML model."""
        if not self.model:
